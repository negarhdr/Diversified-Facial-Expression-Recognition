...
parser.add_argument('--data', type=str, default='../FER_data/RAF-DB/basic/', help='path to dataset')
parser.add_argument('--checkpoint_path', type=str, default='./checkpoint/RAFDB/' + time_str + 'model.pth')
parser.add_argument('--best_checkpoint_path', type=str, default='./checkpoint/RAFDB/'+time_str+'model_best.pth')
...
def main():
    ...
    train_dataset = udata.RafDataSet(args.data, phase='train', transform=data_transforms)
    ...
    val_dataset = udata.RafDataSet(args.data, phase='test', transform=data_transforms_val)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        txt_name = './log/' + time_str + 'RAFDB_div_log.txt'
        with open(txt_name, 'a') as f:
            f.write('Current learning rate: ' + str(current_learning_rate) + '\n')

        # train for one epoch
        train_acc, train_los = train(train_loader, model, criterion_ce, criterion_bdiv, criterion_fdiv, optimizer,
                                     epoch, args)
