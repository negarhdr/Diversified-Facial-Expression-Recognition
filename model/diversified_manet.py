...
class MANet(nn.Module):
    ...
    def _forward_impl(self, x):
        ...
        branch_1_feat = branch_1_out
        branch_1_fc = self.fc_1(branch_1_out)
        ...
        branch_2_feat = branch_2_out
        branch_2_fc = self.fc_2(branch_2_out)

        # Return local and global features to be diversified
        local_feat = []
        local_feat.append(branch_1_p1_out)
        local_feat.append(branch_1_p2_out)
        local_feat.append(branch_1_p3_out)
        local_feat.append(branch_1_p4_out)
        local_feat_b1 = torch.stack(local_feat)  # stack of local features of the first branch

        global_feat = []
        global_feat.append(branch_1_feat)
        global_feat.append(branch_2_feat)
        global_feat_b12 = torch.stack(global_feat)  # stack of global features of the first and second branch

        return branch_1_fc, branch_2_fc, global_feat_b12, local_feat_b1
